...
After-hours settings, all-stage manual checks, and manual monthly report generation also require all-branch scope so branch-scoped users can view their data without changing global schedules.
