...
| GET | `/api/afterhours/config` | AFTERHOURS_VIEW | Get config settings |
| PUT | `/api/afterhours/config` | SYSTEM_HEALTHCHECK | Update config |
| POST | `/api/afterhours/check` | AFTERHOURS_VIEW | Trigger on-demand PC check |
| GET | `/api/afterhours/report/monthly` | AFTERHOURS_VIEW | Monthly violation report |
| GET | `/api/afterhours/report/monthly/export` | AFTERHOURS_VIEW | Export report as XLSX |
| GET | `/api/afterhours/report/monthly/generate` | AFTERHOURS_VIEW | Trigger report generation |
| GET | `/api/afterhours/stats` | AFTERHOURS_VIEW | Statistics (branch totals, trends) |
