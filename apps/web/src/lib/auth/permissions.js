...
/**
 * @typedef {'DASHBOARD_VIEW' | 'SYNC_VIEW' | 'EOD_VIEW' | 'STORES_VIEW' | 'EMPLOYEES_VIEW' | 'BACKUPS_VIEW' | 'SYSTEM_VIEW' | 'ACCOUNTS_VIEW' | 'EOD_SYNC' | 'EOD_RETRY' | 'STORES_EDIT' | 'NIK_LOOKUP' | 'BACKUPS_RUN' | 'BACKUPS_DELETE' | 'BACKUPS_RESTORE' | 'SYSTEM_HEALTHCHECK' | 'SYSTEM_RESTART' | 'USERS_VIEW' | 'USERS_CREATE' | 'USERS_EDIT' | 'USERS_DELETE' | 'USERS_RESET_PASSWORD' | 'USERS_CHANGE_PASSWORD' | 'USERS_ROLE_EDIT' | 'USERS_PERMISSION_EDIT' | 'USERS_SCOPE_EDIT' | 'ROLES_VIEW' | 'ROLES_EDIT' | 'AFTERHOURS_VIEW' | 'AGENT_UPDATE'} Permission
 */
...
export const PermissionGroups = {
  ...
  'Employee Data': ['EMPLOYEES_VIEW', 'NIK_LOOKUP'], // HR Data
