...
function SidebarGroupLabel({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'px-3 py-2 text-3xs font-medium uppercase tracking-wider text-sidebar-foreground/60 group-data-[state=collapsed]/sidebar-wrapper:hidden',
        className
      )}
      {...props}
    />
...
function SidebarMenuButton({
  ...
  const classes = cn(
    ...
    isActive && 'bg-sidebar-primary/12 text-sidebar-primary font-medium before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:h-4 before:w-0.5 before:rounded-full before:bg-sidebar-primary before:shadow-lg shadow-sidebar-primary/30',
    className
  );
