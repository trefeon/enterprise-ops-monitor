...
const PROCESSES = [
  "chrome.exe", "explorer.exe", "python.exe", "node.exe", "msedge.exe",
  "Teams.exe", "Outlook.exe", "Code.exe", "Spotify.exe", "slack.exe",
  "docker.exe", "postgres.exe", "nginx.exe", "java.exe", "powershell.exe",
]
...
function createMachine(
  ...
  return {
    ...
    label,
    specs: {
      cpu_model: ["Intel Core i5-12400", "Intel Core i7-13700", "AMD Ryzen 5 5600", "Intel Core i5-13400", "AMD Ryzen 7 5800X", "Intel Core i3-12100"][randomInt(0, 5)],
