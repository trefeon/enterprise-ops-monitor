    ...
    <main className="min-h-screen bg-background text-foreground">
      <header className="portfolio-container flex items-center justify-between py-5">
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <Link
            className="rounded-lg bg-primary px-3 py-2 font-semibold text-primary-foreground hover:bg-primary/85"
            to="/login"
          >
            Open Demo
          </Link>
      ...
      <section className="portfolio-container pb-12 pt-10">
        <div className="max-w-3xl">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-border bg-card px-3 py-1 text-xs font-semibold uppercase tracking-wide text-primary">
