...
module.exports = {
  ...
  down: async (queryInterface, _Sequelize) => {
    ...
    const indexNames = [
      "idx_Users_org_id_id", "idx_Users_org_id_username",
      "idx_Stores_org_id_store_code", "idx_EODLogs_org_id_store_code_date",
      "idx_BackupLogs_org_id_created_at", "idx_SystemLogs_org_id_created_at",
      "idx_Employees_org_id_nik", "idx_SyncLogs_org_id_store_code_polled_at",
      ...
      "idx_Roles_org_id_name", "idx_UserRoles_org_id_user_id_role_id",
      "idx_UserBranchScopes_org_id_user_id_branch_id",
      "idx_data_stores_org_id_store_code", "idx_data_employees_org_id_nik",
      ...
      "idx_stores_master_org_id_kodetoko", "idx_sync_aud_latest_org_id_kodetoko",
